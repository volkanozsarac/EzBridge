...
inputs = {
    ...
    'Abutment_Foundation': {
        ...
        'file': 'SoilProfiles.xlsx', # File where the soil profiles is saved
...
gm_msa = {
    ...
    'dts_file': "GMR_dts.txt",   # Time steps of ground motions to run for any case case
...
# Bridge.msa(gm_msa, excitation='Multi-Support', signal='-disp', tFree = 5)
